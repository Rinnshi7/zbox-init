  ...
  <div class="modal-dialog">
    ...
    <div class="version-row">
      <div class="free-version">
        ...
        <a class="btn btn-lg" href="https://www.xuanim.com/page/feature.html" target="_blank" rel="noopener noreferrer">
      ...
      <div class="enhance-version">
        <div>
          ...
          <h5>
            <?php echo $lang->conference->detachedConferenceModal->commingSoon;?>
          </h5>
          <ul class="list-style-none">
            ...
            <li class="text-muted">
              <?php echo $lang->conference->detachedConferenceModal->feature->more;?>
            </li>
          </ul>
        </div>
