...
DELETE FROM `zt_grouppriv` WHERE `module` = 'pivot' AND `method` = 'build';
DELETE FROM `zt_grouppriv` WHERE `module` = 'pivot' AND `method` = 'testcase';
DELETE FROM `zt_grouppriv` WHERE `module` = 'pivot' AND `method` = 'workSummary';
