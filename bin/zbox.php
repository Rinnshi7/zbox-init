...
if(is_dir("$basePath/app/zentaomax/"))
{
    `chmod -R 777 $basePath/app/zentaomax/tmp`;
    `chmod -R 777 $basePath/app/zentaomax/www/data`;
    `chmod 777 $basePath/app/zentaomax/www/`;
    `chmod 777 $basePath/app/zentaomax/config/`;
    `chmod -R a+rx $basePath/app/zentaomax/bin/*`;
}
...
if(is_dir("$basePath/app/zentaoipd/"))
{
    `chmod -R 777 $basePath/app/zentaoipd/tmp`;
    `chmod -R 777 $basePath/app/zentaoipd/www/data`;
    `chmod 777 $basePath/app/zentaoipd/www/`;
    `chmod 777 $basePath/app/zentaoipd/config/`;
    `chmod -R a+rx $basePath/app/zentaoipd/bin/*`;
}
...
if(isset($params['-mp']))
{
    ...
    if(file_exists("$basePath/app/zentaomax/config/my.php"))
    {
        `chmod 777 $basePath/app/zentaomax/config/my.php`;
        $myFile = "$basePath/app/zentaomax/config/my.php";
        changePort($myFile, $params['-mp'], $myReg);
    }
    ...
    if(file_exists("$basePath/app/zentaoipd/config/my.php"))
    {
        `chmod 777 $basePath/app/zentaoipd/config/my.php`;
        $myFile = "$basePath/app/zentaoipd/config/my.php";
        changePort($myFile, $params['-mp'], $myReg);
    }
}
